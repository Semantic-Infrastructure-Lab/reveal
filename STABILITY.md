...
- **Languages (full support):** C#, Scala, PHP, Ruby, Lua, Kotlin, Swift, Dart, HCL/Terraform, GraphQL, Protobuf, Zig, GDScript, Bash, SQL — see `reveal --languages` for the current full roster (51 languages and file formats across explicit analyzers + tree-sitter fallback)
- **Features:**
