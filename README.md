...
**Quick Install:**
```bash
pip install reveal-cli              # Full-featured by default (40+ languages, 16 adapters)
...
├── adapters/     # URI support (16 adapters: help://, env://, ast://, stats://, etc.)
...
**For AI agents:** Text output (`filename:line` format) and JSON output (`--format json`) are both production-ready. All 16 adapters follow Output Contract v1.0.
