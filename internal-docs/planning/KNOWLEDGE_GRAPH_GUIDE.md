...
# 2. Beth indexes the file
tia beth rebuild

# 3. Discover via Beth
tia beth explore "reveal front-matter"

# 4. Drill down with reveal
reveal $(beth_result) --frontmatter --related
```
