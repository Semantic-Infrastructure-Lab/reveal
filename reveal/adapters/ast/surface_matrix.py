...
_HAND_CODED: Dict[str, frozenset] = {
    ...
    'java': frozenset({'cli', 'http', 'env', 'fs', *_IMPORT_TAXONOMY}),
    'csharp': frozenset({'cli', 'http', 'env', 'fs', *_IMPORT_TAXONOMY}),
    'php': frozenset({'http', 'env', 'fs', 'subprocess', *_IMPORT_TAXONOMY}),
    'swift': frozenset({'cli', 'http', 'env', *_IMPORT_TAXONOMY}),
    'kotlin': frozenset({'cli', 'http', 'env', 'fs', *_IMPORT_TAXONOMY}),
    'ruby': frozenset({'http', 'env', *_IMPORT_TAXONOMY}),
    'go': frozenset({'cli', 'http', 'env', 'fs', *_IMPORT_TAXONOMY}),
    'rust': frozenset({'cli', 'http', 'env', 'fs', *_IMPORT_TAXONOMY}),
