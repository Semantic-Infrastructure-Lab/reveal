...
_HELP: Dict[str, Any] = {
    ...
    'parameters': {
        ...
        'top':      'Max results for ?rank=callers or ?uncalled (default: 10/?rank, unlimited/?uncalled; 0 = all)',
...
_SCHEMA: Dict[str, Any] = {
    ...
    'query_params': {
        ...
        'top':      {'type': 'integer', 'description': 'Max results for ?rank=callers or ?uncalled (default 10/?rank, unlimited/?uncalled; 0 = all)'},
