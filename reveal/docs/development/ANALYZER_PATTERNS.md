...
- [PYTHON_ADAPTER_GUIDE.md](../adapters/PYTHON_ADAPTER_GUIDE.md) - Python analysis examples
- [DUPLICATE_DETECTION_GUIDE.md](../guides/DUPLICATE_DETECTION_GUIDE.md) - Duplicate detection patterns
