...
| `reveal contracts [path]` | Architectural seams: ABCs, Protocols/interfaces, TypedDicts, dataclasses *(9 languages: Python, TypeScript, Java, C#, PHP, Swift, Kotlin, Ruby, Go)* | `reveal contracts --help` |
| `reveal surface [path]` | External surfaces: CLI commands, HTTP routes, env vars, network calls, FS writes *(9 languages: Python, TypeScript, Java, C#, PHP, Swift, Kotlin, Ruby, Go)* | `reveal surface --help` |
