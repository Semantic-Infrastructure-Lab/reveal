...
| `reveal contracts [path]` | Architectural seams: ABCs, Protocols/interfaces, TypedDicts, dataclasses *(10 languages: Python, TypeScript, Java, C#, PHP, Swift, Kotlin, Ruby, Go, Rust)* | `reveal contracts --help` |
| `reveal surface [path]` | External surfaces: CLI commands, HTTP routes, env vars, network calls, FS writes *(10 languages: Python, TypeScript, Java, C#, PHP, Swift, Kotlin, Ruby, Go, Rust)* | `reveal surface --help` |
