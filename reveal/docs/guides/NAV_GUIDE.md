...
Nav flags work on Python, PHP, and the other tree-sitter languages (`reveal --languages`). Most flags accept `:LINE-RANGE` and work on flat procedural files (no function wrapper required).
