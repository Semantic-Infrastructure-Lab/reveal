...
def extract_js_imports(file_path: Path) -> List[ImportStatement]:
    ...
    Args:
        file_path: Path to .js, .jsx, .ts, or .tsx file
    ...
    # Extract ES6 imports
    imports.extend(_extract_es6_imports(file_path, content))

    # Extract CommonJS require()
    imports.extend(_extract_require_imports(file_path, content))

    # Extract dynamic import()
    imports.extend(_extract_dynamic_imports(file_path, content))
